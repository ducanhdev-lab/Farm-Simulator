import { getActiveEventsFromDb, type LiveEventRow } from "../repositories/eventsRepository.js";
...
const fallbackCatalog: LiveEvent[] = [
  {
    eventId: "event_snow",
    sceneName: "Level02",
...
function mapRow(row: LiveEventRow): LiveEvent {
  return {
...
export async function getActiveEvents(now = new Date()): Promise<LiveEvent[]> {
  try {
